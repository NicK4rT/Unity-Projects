...
while (!is.na(dataRB$Time[c1])) {
  ...
  dataRB$pitch[c1] <- atan(sqrt(P_it[2]*P_it[2])/sqrt(P_it[3]*P_it[3]));
  dataRB$roll[c1] <- atan(sqrt(P_it[1]*P_it[1])/sqrt(P_it[3]*P_it[3]));
  
  if(P_it[3] < 0){
    dataRB$roll[c1] <- dataRB$roll[c1]+90;
  }
  if(P_it[2] < 0){
...
while (!is.na(dataLR$Time[c1])) {
  ...
  dataLR$pitch[c1] <- atan(sqrt(P_it[2]*P_it[2])/sqrt(P_it[3]*P_it[3]));
  dataLR$roll[c1] <- atan(sqrt(P_it[1]*P_it[1])/sqrt(P_it[3]*P_it[3]));
  
  if(P_it[3] < 0){
    dataLR$roll[c1] <- dataLR$roll[c1]+90;
  }
  if(P_it[2] < 0){
...
while (!is.na(dataVR$Time[c1])) {
  ...
  dataVR$pitch[c1] <- atan(sqrt(P_it[2]*P_it[2])/sqrt(P_it[3]*P_it[3]));
  dataVR$roll[c1] <- atan(sqrt(P_it[1]*P_it[1])/sqrt(P_it[3]*P_it[3]));
  
  if(P_it[3] < 0){
    dataVR$roll[c1] <- dataVR$roll[c1]+90;
  }
  if(P_it[2] < 0){
...
nameRB2 <- expand.grid('/Sorting/US',1:31,'RB.csv');
nameRB2 <- apply(nameRB2,1,paste0,collapse = "");
nameLR2 <- expand.grid('/Sorting/US',1:31,'LR.csv');
nameLR2 <- apply(nameLR2,1,paste0,collapse = "");
nameVR2 <- expand.grid('/Sorting/US',1:31,'VR.csv');
