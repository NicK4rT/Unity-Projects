...
while(!is.na(dataRB$Time[c1])) {
  ...
  dataRB$pitch[c1] <- atan(sqrt(P_it[1]*P_it[1]+P_it[3]*P_it[3])/sqrt(P_it[2]*P_it[2]));
...
while (!is.na(dataLR$Time[c1])) {
  ...
  dataLR$pitch[c1] <- atan(sqrt(P_it[1]*P_it[1]+P_it[3]*P_it[3])/sqrt(P_it[2]*P_it[2]));
...
while (!is.na(dataVR$Time[c1])) {
  ...
  dataVR$pitch[c1] <- atan(sqrt(P_it[1]*P_it[1]+P_it[3]*P_it[3])/sqrt(P_it[2]*P_it[2]));
  ...
  if(c1 > 3){
    dataVR$V2[c1-2] <- ((dataVR$V2[c1-2]-dataVR$V2[c1-3])/(dataVR$Time[c1-2]-dataVR$Time[c1-3])+(dataVR$V2[c1-1]-dataVR$V2[c1-2])/(dataLVR$Time[c1-1]-dataVR$Time[c1-2]))/2;
  }
