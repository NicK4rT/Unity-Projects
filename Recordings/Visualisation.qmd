...
ggplot(B5.B79.RB10, aes(x = -yaw2, y = pitch2, color = "blue")) +
  geom_path() +
  geom_path(data = B5.B79.LR10, aes(x = yaw2, y = pitch2, color = "green")) +
  geom_path(data = B5.B79.VR10, aes(x = yaw2, y = -pitch2, color = "red")) +
