...
namespace ViveRecorder
{
    public class TobiiXRRecorder : IRecorder
    {
        ...
        string content = "FocusedObject,LeftBlink,RightBlink,RayOrigin_x,RayOrigin_y,RayOrigin_z,RayDirection_x,RayDirection_y,RayDirection_z,locRayDirection_x,locRayDirection_y,locRayDirection_z,ConvergenceDistance,foc_Objectpos_X,foc_Objectpos_Y,foc_Objectpos_Z";
        ...
        public Vector3 locrayDirection = new Vector3(0f, 0f, 0f);
    ...
    */
        ...
        public bool GetRecordingData(out string data)
        {
            ...
            */
            ...
            TobiiXR_EyeTrackingData eyeTrackingDataLocal= TobiiXR.GetEyeTrackingData(TobiiXR_TrackingSpace.Local);
            ...
            if (eyeTrackingData.GazeRay.IsValid)
            {
                ...
                locrayDirection = eyeTrackingDataLocal.GazeRay.Direction;
                ...
                AddVectorToList(locrayDirection);
