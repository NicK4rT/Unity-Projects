...
namespace Valve.VR.InteractionSystem
{
	...
	public class Teleport : MonoBehaviour
    {
        ...
        public SteamVR_Action_Boolean indicationAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("TeleportIndication");
		...
		void Update()
		{
			...
			foreach ( Hand hand in player.hands )
			{
				...
				if (IsTeleportButtonTouched( hand ) )
				{
					newPointerHand = hand;
				}
			}
        ...
        private bool IsTeleportButtonTouched(Hand hand)
        {
            if (IsEligibleForTeleport(hand))
            {
                if (hand.noSteamVRFallbackCamera != null)
                ...
                {
                    //return teleportAction.GetStateDown(hand.handType);
                    return indicationAction.GetState(hand.handType);
                    //return hand.controller.GetPressDown( SteamVR_Controller.ButtonMask.Touchpad );
                }
            }
            return false;
